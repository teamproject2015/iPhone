...
public class TemperatureResultReceiver extends ResultReceiver {
    ...
    public static final String EXTRA_ERRORMSG = "TemperatureResultReceiver.ERRORMSG";

    public static final int RESULTCODE_UPDATE = 1;
    public static final String EXTRA_X = "TemperatureResultReceiver.X";
    public static final String EXTRA_Y = "TemperatureResultReceiver.Y";
    public static final String EXTRA_Z = "TemperatureResultReceiver.Z";
